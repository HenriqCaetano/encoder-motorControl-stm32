/**
  ***********************************************************************************
  * @file           : tawan_joseph_encoder_drive.h
...
/**
  ******************************************************************************
  * @brief          : Acquire encoder data and motor speed calculation (dataSheet)
  ******************************************************************************
**/
#define CNT_DIR_CW 1
...
#define ENT_CNT_PER_REV 48 // Encoder counts/rev
...
typedef struct Controller_I_Struct;
{
...
typedef struct Controller_PI_Struct
{
  float kp; //assign as variable instead of #define as pre-compile for on-board adjusting purpose
  float ki; //assign as variable instead of #define as pre-compile for on-board adjusting purpose
